...
import com.adv.util.base.enums.ResultEnum;
import com.adv.util.base.tools.RequestUtil;
    ...
    public void onAuthenticationSuccess(HttpServletRequest request,
        ...
        try {
            ...
            TokenRequest tokenRequest =
                    new TokenRequest(Collections.emptyMap(), clientId,
            ...
            result = Result.error(ResultEnum.AUTH_FAIL.getCode(), e.getMessage());
        }
