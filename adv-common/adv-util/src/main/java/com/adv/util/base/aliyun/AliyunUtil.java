package com.adv.util.base.aliyun;

import cn.hutool.core.date.DateUtil;
import com.adv.util.base.base.Result;
import com.adv.util.base.enums.PlatformEnum;
import com.adv.util.base.properties.AliyunProperties;
...
public final class AliyunUtil {
    ...
    public static Result uploadFileToOss(PlatformEnum platformEnum, MultipartFile file, AliyunProperties aliyun ) {
        ...
        String folderName = platformEnum.name().toLowerCase() + "/" + DateUtil.format(new Date(), "yyyyMMdd");
